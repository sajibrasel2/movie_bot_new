#!/usr/bin/env python3
"""
BD Politics News Deliverer
============================
Same as deliver_posts.py but uses config_bdpolitics.py
Delivers queued news to @bdwar71 channel
"""
...
# Now import and run deliver_posts with bdpolitics config
from deliver_posts import main
import asyncio
